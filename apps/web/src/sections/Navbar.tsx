  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "border-b border-border/50 glass-strong"
          : "bg-transparent",
      )}
    >
      <Container>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="border-t border-border/50 bg-surface/95 backdrop-blur-xl md:hidden"
          >
            <Container className="py-4">
              <div className="flex flex-col gap-1">
                ...
                <a
                  href="/login"
                  className="rounded-lg px-4 py-3 text-sm font-medium text-muted transition-colors hover:text-foreground"
                >
                  Log in
                </a>
